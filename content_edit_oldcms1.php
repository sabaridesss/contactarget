  ...
  <tr>
    <td align="left" valign="top" class="login-inner"><table width="100%" border="0" align="center" cellpadding="5" >
      <tr>
        ...
        <td width="83%" align="left"><textarea name="meta_title" cols="90" rows="5" id="meta_title"  class="login-textarea1"><?=$meta_title?>
        </textarea></td>
      </tr>
      <tr>
        <td align="right" valign="top" id="title_name"><span class="font">&nbsp;Meta-Description</span>:</td>
        <td align="left"><textarea name="meta_content" cols="90" rows="5" id="meta_content" class="login-textarea1"><?=$meta_content?>
        </textarea></td>
      </tr>
      <tr>
        <td align="right" valign="top"><span class="font">&nbsp;Meta-Keyword:</span></td>
        <td align=""><textarea name="meta_keyword" cols="90" rows="5" id="meta_keyword" class="login-textarea1"><?=$meta_keyword?>
        </textarea></td>
      </tr>
      <tr>
        <td align="right" valign="top"><span class="font">H1:</span></td>
        <td align=""><input name="header_title1" type="text" id="header_title1" value="<?=$header_title1?>" class="login-texbox1" size="90"></td>
      </tr>
      <tr>
        <td align="right" valign="top"><span class="font">H2:</span></td>
        <td align=""><input name="header_title2" type="text" id="header_title2" value="<?=$header_title2?>" class="login-texbox1" size="90" /></td>
      </tr>
      <tr>
        <td align="right" valign="top"><span class="font">&nbsp;Meta-Misc:</span></td>
        <td align=""><textarea name="meta_misc" cols="90" rows="5" id="meta_misc" class="login-textarea1"><?=$meta_misc?>
        </textarea></td>
      </tr>
      <tr>
        <td align="right" valign="top"><span class="font">&nbsp;Page Name:</span></td>
        <td align=""><input name="page_name" type="text" id="page_name" value="<?=$page_name?>" size="90" class="login-texbox1"/></td>
      </tr>
      <tr>
