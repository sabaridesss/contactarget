...
$adjacents = 4;
$total_pages = $no_of_opened; 
$targetpage = "opened_details.php?send_id=".$id; 			//if no page var is given, set start to 0
$num_res_count=$no_of_opened_page;
            ...
            <table border="0" align="center" class="table table-striped table-bordered bootstrap-datatable datatable">
              <thead>
                <tr class="table1">
                  ...
                  <td align="left" >Opend On</td>
                </tr>
              </thead>
              <?php 
			if($no_of_opened>0) {
				while($item=mysql_fetch_array($no_of_opened_Blasts_page)){
	     ...
	     $class="table3";
			?>
              <tr class="<?=$class?>" >
                ...
                <td width="15%" align="left" class="font2"><?=$item['opentime'];?></td>
              </tr>
              <?php $i++;}} ?>
              <tr >
