...
else
{
	...
	{
		$insert_query = "insert into industry (industry_name) values('".$_POST["category"]."')";
		$result = mysql_query($insert_query);
		if($result){
		/*print"<script>alert('Inserted successfully')</script>";
		*/
		print"<script>location.href='view_industry.php?msg=2'</script>";
		}
	}
	...
	if(isset($_REQUEST['category_id']) != '')
	{
		...
		$cat_query = 'select * from industry where industry_id ='.$category_id;
	...
	{
		$category_id = $_REQUEST['category_id'];
		$insert_query = 'UPDATE industry  
										SET
											industry_name = \''.$_POST['editCat'].'\'
											WHERE industry_id ='.$category_id;
										
		$result = mysql_query($insert_query);
		if($result){
		/*print"<script>alert('Inserted successfully')</script>";
		*/
		print"<script>location.href='view_industry.php?msg=3'</script>";
		}
	}
	
	if(isset($_REQUEST['Close']) && $_REQUEST['Close'] == 'Close')
	{
		print"<script>location.href='view_industry.php'</script>";
	}
...
<div class="content">
		  ...
		  <table width="60%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="left" valign="top" class="login-top"><span class="style4">Edit Industry</span></td>
            </tr>
            <tr>
              <td align="left" valign="top" class="login-inner"><table width="100%" border="0" align="center" cellpadding="5" >
                  <tr>
                    <td align="right" valign="top" id="title_name"><span class="style3">Industry Name </span>:</td>
                    <td align="left"><input name="editCat" type="text" id="editCat" size="50" value="<?php echo $row['industry_name']; ?>"  class="login-textarea1"/></td>
                  </tr>
            ...
            <table width="60%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="left" valign="top" class="login-top"><span class="style4">Add Industry</span></td>
            </tr>
            <tr>
              <td align="left" valign="top" class="login-inner"><table width="100%" border="0" align="center" cellpadding="5" >
                  <tr>
