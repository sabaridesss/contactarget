				...
				if(mysql_query($query)) {
					if(isset($_REQUEST['parent_id'])) {
						...
						if($_REQUEST['action'] == "edit_page_contents") {
							...
							header("location:all_page_index.php?msg=3");
						} else {
...
{
	header('location:all_page_index.php'); 
}
  ...
  <tr>
    <td align="left" valign="top" class="login-inner"><table width="100%" border="0" align="center" cellpadding="5" >
      <tr>
        ...
        <td width="78%" align="left"><textarea name="meta_title" cols="135" rows="5" id="meta_title"  class="login-textarea1" readonly="readonly"><?=$meta_title?></textarea></td>
      </tr>
      <tr>
        <td align="right" valign="top" id="title_name"><span class="font">&nbsp;Meta-Description</span>:</td>
        <td align="left"><textarea name="meta_content" cols="135" rows="5" id="meta_content" class="login-textarea1"><?=$meta_content?></textarea></td>
      </tr>
      <tr>
        <td align="right" valign="top"><span class="font">&nbsp;Meta-Keyword:</span></td>
        <td align=""><textarea name="meta_keyword" cols="135" rows="5" id="meta_keyword" class="login-textarea1" readonly="readonly"><?=$meta_keyword?></textarea></td>
      </tr>
<!--      <tr>
     ...
     <tr>
        ...
        <td align=""><textarea name="meta_misc" cols="135" rows="5" id="meta_misc" class="login-textarea1"><?=$meta_misc?>
        </textarea></td>
      </tr>
--> 
      <tr>
        <td align="right" valign="top"><span class="font">&nbsp;Page Name:</span></td>
        <td align=""><input name="page_name" type="text" id="page_name" value="<?=$page_name?>" size="135" class="login-texbox1" readonly="readonly"/></td>
      </tr>
<!--      <tr>
