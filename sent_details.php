...
$adjacents = 4;
$total_pages = $no_of_successcount; 
$targetpage = "sent_details.php?send_id=".$id; 			//if no page var is given, set start to 0
$num_res_count=$no_of_successcount_page;
		 ...
		 ?>
          <div  style="width:64%">
            <table border="0" align="center" class="table table-striped table-bordered bootstrap-datatable datatable">
              ...
              <?php 
			if($no_of_successcount>0) {
				while($item=mysql_fetch_array($no_of_success_page)){
