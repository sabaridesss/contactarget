...
if($page_name != ""){
$query = "select * from `childtaps_tpl` where child_id ='".$page_name."'";
$query_result = mysql_query($query);
$num_rows = mysql_num_rows($query_result);
}
else{
$query = "select * from `childtaps_tpl`";
$query_result = mysql_query($query);
}

$msg = "";
if($_REQUEST["msg"] == '1'){
	$msg = "Child Tab Menus Sucessfully Added";
	
}else if($_REQUEST["msg"] == '2'){

	$msg = "Child Menus Sucessfully Updated";
	
}

$page_query = "select * from `sub_subpagecontents`";
...
<script src="http://www.rapidtorc.com/javascript/admin_javascript.js" type="text/javascript"></script>
...
<table width="950" border="0" cellpadding="5">
  <tr>
    ...
    <td width="103"><a href="tap_menus.php"><strong> Tab Menus </strong></a></td>
  ...
  <tr>
    ...
    <td height="395" colspan="5" align="center" valign="top"><table width="381" border="0" cellpadding="5">
      ...
      <table width="676" border="0" cellpadding="5">
        <tr>
          <td width="505" align="right" class="style3"><strong>Sort By Pagename: </strong>
			...
			?>
			<option value="<?=$row['sub_id']?>"><?=$page_name?></option>
			<? } }?>
          </select>
          </td>
          <td width="145" align="right"><a href="childtaps_add.php"><strong>Add Child Tabs </strong></a></td>
        </tr>
      </table>
      ...
      <tr bgcolor="#cccccc">
        ...
        <td align="left" class="style3"><strong>Child Tabs Name</strong></td>
        <td align="left" class="style3"><strong>Child Tabs Description </strong></td>
      ...
      <tr bgcolor="<?=$bgcolor?>" onmouseover="this.className='tableover'" onmouseout="this.className='dataclass'">
        ...
        <td width="18%"><table width="100%"  border="0">
            <tr>
              <td width="24%" align="center"><a href="edit_childtaps.php?tabs_id=<?=$item["tap_id"]?>" class="style3"> <img src="../images/edit.gif" alt="edit" border="0" title="edit" /></a> </td>
              <td width="37%" align="center"><a href="javascript:void(0)" class="style3"> <img src="../images/delete.gif" alt="delete" border="0" title="delete" onclick='deleteContent(<?=$item["tap_id"]?>,"delete_child_tabs")' /></a> </td>
            </tr>
        </table></td>
      </tr>
