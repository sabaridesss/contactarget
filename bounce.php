...
require_once('callback_samples/callback_database.php'); // NOTE: Requires modification to insert your database settings
...
$bmh->mailhost           ='pop.1and1.com'; // your mail server
$bmh->mailbox_username   = 's.rajan@desss.com'; // your mailbox username
$bmh->mailbox_password   = 'RamyaSri'; // your mailbox password
...
$bmh->service_option     = 'tls'; // the service options (none, tls, notls, ssl, etc.), default is 'notls'
...
$bmh->deleteMsgDate      = date("Y-m-d"); // format must be as 'yyyy-mm-dd'
