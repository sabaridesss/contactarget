...
if( !isset($_SESSION['username']) ) {
	...
	{
		$select = 'SELECT * FROM contentinfo order by id desc';
		...
		$insert = 'INSERT INTO contentinfo
										...
										desc_content	= \''.addslashes($_POST['desc_content']).'\',
		...
		header('location:content_info.php?msg=2&page_id='.$page_id);									
...

{
	...
	$editImg = 'SELECT * FROM  contentinfo WHERE id ='.$_REQUEST['menus_id'];
...
{$page_id= $_REQUEST['page_id'];
	header('location:content_info.php?page_id='.$page_id);		
}
...
{		
	...
	header('location:content_info.php?msg=3&page_id='.$page_id);								
              ...
              <tr>
                <td align="left" valign="top" class="login-inner"><table width="100%" border="0" align="center" cellpadding="5" >
                    <tr>
                     ...
                     <!--<tr>
                      <td width="20" align="right" valign="top" id="title_name">Content:</td>
                       </tr>
                       <tr>
                       <td colspan="2">
                      <textarea name="desc" id="desc" cols="35" rows="8"><?=$viewRow["desc_data"]?>
</textarea><script type="text/javascript">
    CKEDITOR.replace('desc');
 </script>
                   </td></tr>-->
                   <tr>
        <td  width="100" align="right" valign="top">Tab Description:</td>
        <td align=""></td></tr>
        <tr><td colspan="2"><textarea id="desc_content" name="desc_content" rows="8" cols="35" class="login-textarea1"><?=$viewRow["desc_content"]?></textarea>
		
<script type="text/javascript">



ed = CKEDITOR.replace("desc_content",
{
   ...
   // CKEDITOR.replace('tab_desc');
	  ...
	  ?>
                    <tr>
                      ...
                      <td align=""><img src="../uplodeImage/desc_content/<?=$viewRow["image"]?>" width="180" height="130" /> </td>
                    </tr>
                    <?php } ?>
