...
if( !isset($_SESSION['username']) ) {
	...
	if(mysql_num_rows($company_result)>0) {
		...
		{
		$query = "INSERT INTO admin(bounce_password,bounce_email,company_admin,username,password,user_permission,role,created_date)VALUES('".$bounce_password."','".$bounce_email."','".$company."','".$title."','".$page_name."',1,'".$role_contact."','date()')";	
