...
if( !isset($_SESSION['username']) ) {
    ...
    $query2= "select * from banner_template_new";
	...
	if($_REQUEST['delete']=="true") {
		...
		$query = "delete from banner_template_new where template_id =".$id;
		if(mysql_query($query)) {
					header("Location:banner_template.php?msg=4");		
				}
	}
}
...
<div class="welcome-admin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="14%" align="right" valign="middle"><div class="addmenu"><a href="add_banner-template.php">Add Template</a></div></td>
  </tr>
</table>
</div>
<div class="content">
<table width="100%" border="0"  class="content">
      ...
      <tr class="<?= $class ?>" >
        ...
        <td width="26%" height="20" align="left" valign="middle" style="padding-left:10px;"><img src="../images/templates/<?=$item["template_name"]?>" width="120" height="70" /></td>
        <td width="29%" style="padding-left:10px;">
		<table width="100%"  border="0">
            <tr>
              <td width="21%" height="20" align="center"><a href="edit_banner-template.php?id=<?=$item["template_id"]?>" class="style3">Edit </a> </td>
              <td width="31%" height="20" align="center"><a href="banner_template.php?id=<?=$item["template_id"]?>&delete=true" class="style3" onclick='return deleteContent1(<?=$item["template_id"]?>,"delete_menus","")'> Delete</a> </td>
              </tr>
        </table></td>
      </tr>
      <? $i++; } ?>
