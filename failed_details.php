    ...
    <tr>
      ...
      <div class="wholesite-inner">
        <!--welcome admin start here-->
		  ...
		  $adjacents = 4;
$total_pages = $no_of_failed; 
$targetpage = "failed_details.php?send_id=".$id; 			//if no page var is given, set start to 0
$num_res_count=$no_of_failed_page;
	...
	{	  $i=$start + '1';
        ...
        <div style="width:64%">
          ...
          <thead>
            ...
            <?php 
			if($no_of_failed>0) {
				while($item=mysql_fetch_array($no_of_failed_Blasts_page)){
