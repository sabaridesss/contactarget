...
$test='<h1>
	<a href="http://www.desss.com/staffing/staffing-services-houston.html" style="text-decoration:none" onclick="test_function();">Staffing Services Company Houston</a></h1>
<div class="content_desss">
	<p>
		The most important feature of any company is its staff. Without the right staff, a company isn&#39;t very likely to succeed. If you&#39;re having trouble finding the right staff for your company, don&#39;t panic - call our Staffing Agency Houston today! Our company of outsourcing consultants guarantees affordable rates and prices in services and solutions involving contract and temporary staffing agencies.</p>
	<p>
		Our <strong>Staffing Agency Houston</strong> Services strives to find people that are the perfect fit for your company - those with the right skills and the best abilities. From full-time staffing to temporary, contract, or sub-contract staffing, we can handle it all! Our company of outsourcing consultants guarantees affordable rates and prices in services and solutions involving contract and temporary staffing agencies. None of our competitors can beat us - and that&#39;s a promise.</p>
	<p>
		<strong>Staffing Agency Houston Following Services And Activities:</strong></p>
	<ul>
		<li>
			HR management</li>
		<li>
			Marketing, sales, and accounting</li>
		<li>
			Data entry and conversion</li>
		<li>
			Clerical and reception</li>
		<li>
			Litigation coding</li>
		<li>
			Medical transcription, billing, and coding</li>
	</ul>
	<p>
		Our company of outsourcing consultants guarantees affordable rates and prices in services and solutions involving contract and temporary staffing agencies. No matter how big or how small your company and budget may be, our staffing and placement agency services firmly believe that you deserve to receive superior employees - without having to break the bank in order to do so!</p>
	<p>
		Our <strong>Staffing Agency Houston</strong> services are provided to you by a team of highly talented, experienced, and knowledgeable experts who have been performing superior work for years. They&#39;ll work closely with you every step of the way to ensure that every single one of your wants and needs are met, no matter what they may be.</p>
	<p>
		Turn your company into a better, more productive place - <a href="http://www.desss.com/webdesign/websitedesignquote.aspx"><strong>call</strong></a> our Staffing Agency Houston services today!</p>
</div>';
...
$eventfileTmp      =     $_FILES["mailattach"]["tmp_name"];
 ...
 $upload           =     move_uploaded_file($eventfileTmp,$banPathNme);
	...
	{
	$cond = "and `user_type` = '".$_SESSION['select_email']."'";
	}
	 $email_query_count    = "SELECT * FROM user_tbl where status = '0' AND subscribe = '0' ".$cond." order by id";
...
//campaign_list
	...
	/*  $fet_user =  "select * from mail_address where mail = ".$headers1;
	  $fet_impl =   mysql_query($fet_user);
	  $fet_qual =   mysql_fetch_array($fet_impl);*/
...
$send.=	"<img width='1px' height='1px' src='http://www.emailblast.local-listing.us/get_count.php?sent_id=".$email_address."&id=".$campaign_id."&sendlist=".$_SESSION['send_id']."' align='left' style='position:absolute; left:10px; top:0px;'  />"; 
  $send.='<img src="http://www.emailblast.local-listing.us/mail_logo/services_many.png" style=" float:right;">
...
$send .= '<div class="spacer"></div><div align="center"> <a href="#"><img src="http://www.emailblast.local-listing.us/mail_logo/desss-logo_footer.png" alt="" title="" style="margin-top:15px;" /></a>
	...
	<div style="display:inline-block; margin-top:10px;"> <font color="#909c9f" size="2" face="Arial"> <span style="font-size:12px;"> To stop receiving these emails, you may<a target="_blank" style="color:#FD600B;text-decoration:none;"  href="http://emailblast.local-listing.us/manage.php?user='.$userid.'"> unsubscribe now. </a> </span> </font> </div>
...
/*				$sel_user =  "select * from mail_address";
      ...
      <tr>
        <td colspan="2" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center"><textarea name="content_desc" class="login-textarea1" cols="175"><?=$test?></textarea>
