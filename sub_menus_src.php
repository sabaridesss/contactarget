...
<td align="right"><?php include("top_menu.php"); ?></td>
  ...
  <tr>
    ...
    <td height="395" colspan="5" align="center" valign="top"><table width="381" border="0" cellpadding="5">
      ...
      <table width="703" border="0" cellpadding="5">
        <tr>
          <td width="689" align="right"><a href="add_submenus.php"><strong>Add Sub Menus</strong></a></td>
        </tr>
      </table>
      ...
      <tr bgcolor="<?=$bgcolor?>" onmouseover="this.className='tableover'" onmouseout="this.className='dataclass'">
        ...
        <td width="30%"><table width="100%"  border="0">
            <tr>
              <td width="25%" align="center"><a href="edit_submenus.php?submenus_id=<?=$item["id"]?>" class="style3"> <img src="../images/edit.gif" alt="edit" border="0" title="edit" /></a></td>
              <td width="21%" align="center"><a href="javascript:void(0)" class="style3"><img src="../images/delete.gif" alt="delete" border="0" title="delete" onclick='deleteContent(<?=$item["id"]?>,"delete_submenus")' /></a></td>
              <td width="54%" align="center"><a href="content_edit.php?content_id=<?=$item["id"]?>" class="style3">Edit Content</a></td>
            </tr>
        </table></td>
      </tr>
      <? $i++; } ?>
