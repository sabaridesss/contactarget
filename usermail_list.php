      ...
      <td align="center" class="top"><?php include('common/top_menu.php') ?>
        ...
        <div><?=$msg?></div>
		  ...
		  while($tbl_main_cat_Fetch = mysql_fetch_array($query1_tbl_main_cat)) {?>
                ...
                <td width="15%" align="right" valign="middle" ><a href="upload_users.php" class="btn btn-large btn-primary"><i class="icon-chevron-left icon-white"></i>Import .csv</a> </td>
          ...
          <div class="sortable row-fluid">
			...
			<span class="icon32 icon-red icon-user"></span>
					...
					$user_tot_aud = "select user_type from bounce_tbl WHERE company_admin='$company_admin'"; 
					$user_tot_aud1 = mysql_query($user_tot_aud);
					echo mysql_num_rows($user_tot_aud1);
					}
					else
					{
				...
				<a data-rel="tooltip" title="12 new messages." class="well span3 top-block" href="#">
					...
					if($search!='All')
					{
					 $user_tot_aud = "select user_type from  user_tbl WHERE  company_admin='$company_admin' AND  subscribe = 1 and Bounced != 1  AND `user_type` = '".$search."'"; 
					$user_tot_aud = mysql_query($user_tot_aud);
