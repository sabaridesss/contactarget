...
$displaySite = $php_mail->gettemplates($item_save1['template'],$company_admin);	
...
$preview_banner       =     $item_save1['banner']; 
...
if($num_fetch_banner['image_name']=="")
{
 ...
 }else
 {
  ...
  $image_banner="<div style='clear:both'></div><img src='http://www.contacttarget.com/uploads/banner/".$num_fetch_banner['image_name']."' height='200px' width='100%' style='display:inline'/>";
 }
...
echo "<br/>";*/
 ...
 $template_footer           =   $php_mail->template_footer($logo,$fb,$tw,$gplus,$st,$lin,$content);
  ...
  $template_midheader =	"<a style='text-decoration:none;'  href='http://contacttarget.com/count_url.php?crypt_url=".$fet_camp['crypt_url']."&campid=".$campaign_id."&user=".$array_k['id']."&sendlist=".$send_id."&company_users=".$company_admin."'><img class='img_cls' width='202' height='91' src='http://contacttarget.com/get_count.php?sent_id=". $array_k['id']."&id=".$campaign_id."&sendlist=".$send_id."&templateid=".$template."' align='left' style='position:absolute; left:10px; top:0px;'  /></a>";
    ...
    <a style="color:#FD600B;text-decoration:none;"  href="http://contacttarget.com/count_url.php?crypt_url='.$fet_camp['crypt_url'].'&campid='.$campaign_id.'&user='.$array_k['id'].'&sendlist='.$send_id.'&company_users='.$company_admin.'">Click here </a>if this email does not display correctly<div class="spacer"></div>';
    $template_unsub=	' <div class="spacer"></div>
    To stop receiving these emails, you may<a target="_blank" style="color:#FD600B;text-decoration:none;"  href="http://contacttarget.com//manage.php?user='.strtr(base64_encode(addslashes(gzcompress(serialize($array_k['id']),9))), '+/=', '-_,').'"> unsubscribe now. </a> <div class="spacer"></div>';
...
{	
       ...
       $send = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/><title>Katy Tamil Friends</title><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html;charset=utf-8"/><title>Katy Tamil Friends</title><style>*{margin:0;padding:0}body{padding:0px;margin:0px;}td{padding:0px;margin:0px;border:none !important;display: flex !important;}tr{padding:0px;margin:0px;border:none !important;display: flex !important;}img{padding:0px;margin:0px;border:none !important;width:100%;}a{display: flex !important;}</style></head><body>'.$template_midfooter.$content_desc.'<img src="http://www.contacttarget.com/get_count1.php?sent_id='. $array_k['id'].'&id='.$campaign_id.'&sendlist='.$send_id.'&templateid='.$template.'" alt="" title=""  width="1px" height="1px" style="display:none" /></table></body></html>';
...
{
require("mail_send_tpl/".$displaySite['design_mail']);
$send.='<img src="http://www.contacttarget.com/get_count1.php?sent_id='. $array_k['id'].'&id='.$campaign_id.'&sendlist='.$send_id.'&templateid='.$template.'" alt="" title=""  width="1px" height="1px" style="display:none" />';		 		 
}
else
{
require("mail_send_tpl/tpl_one.php ");
