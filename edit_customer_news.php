...
if( !isset($_SESSION['username']) ) {
	...
	if(isset($_REQUEST['Edit']) && $_REQUEST['Edit'] == 'Edit')
	{
		...
		$insertQuery = 'UPDATE nl_subscribers_tbl  
										SET
											cust_type = \''.$_REQUEST['cType'].'\'
											WHERE id ='.$custId;
		$exQuery = mysql_query($insertQuery);
		header('location:subscriber_cust_view.php');									
	}
	...
	$selectCust = 'SELECT * FROM nl_subscribers_tbl WHERE id ='.$custId;
...
<div class="content"><br>
  ...
  <tr>
    <td align="left" valign="top" class="login-inner"><table width="100%" border="0" align="center" cellpadding="5" >
      ...
      <tr>
        <td width="210" align="right" valign="top" id="title_name">E-Mail Id :</td>
        <td width="482" align="left"><input name="cust_name" type="text" id="cust_name" size="60" class="login-texbox1" value="<?php echo $rowCust['mail'];?>" readonly="readonly"/></td>
      </tr>
      <tr>
