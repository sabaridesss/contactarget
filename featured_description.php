...
if( !isset($_SESSION['username']) ) 
{
 ...
 $page_id=$_REQUEST["page_id"];
	...
	$del_id=$_REQUEST['del_id'];
	 $del_query = "delete from  featured_table where id = $del_id";
	 ...
	 header("location:featured_description.php?msg=4&page_id=".$_REQUEST['page_id']);	
 ...
 $select = 'SELECT * FROM  featured_table WHERE page_id='.$page_id.' ORDER BY id DESC';
      ...
      <td colspan="2" align="right" valign="middle"><table width="35%" border="0" cellspacing="0" cellpadding="0">
          <tr>
           <!-- <td><div class="addmenu"><a href="video_gallery_view.php">Video Gallery</a></div></td>-->
            <td><div class="addmenu"><a href="add_feature.php?page_id=<?=$page_id?>">Add Title</a></div></td>
          </tr>
      </table></td>
    </tr>
  </table>
...
<table width="100%" border="0" >
      ...
      <tr class="<?= $class ?>" >
		...
		<td height="20" align="left" style="padding-left:10px;">&nbsp;&nbsp;<a href="edit_feature.php?id=<?=$item["id"]?>&page_id=<?=$page_id?>" class="style3">Edit </a></td>
		<td width="5%" style="padding-left:10px;"><a onClick="return confirmDelete();" href="featured_description.php?del_id=<?=$item["id"]?>&page_id=<?=$page_id?>" class="style3" > Delete</a> </td>
      </tr>
      <? $i++; } ?>
    </table>
</div>
