...
if($_REQUEST['delete']=="true")
	 {
			...
			$query = "delete from addinfo where id ='".$menus_id."'";
			if(mysql_query($query))
			{
				header("Location:view_info.php?msg=4&page_id=".$_REQUEST['page_id']);		
			}
 ...
 $select = "SELECT * FROM addinfo WHERE page_id =".$_REQUEST['page_id'];
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td colspan="2" align="right" valign="middle"><table width="35%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><div class="addmenu"><a href="add_info.php?page_id=<?=$page_id?>">Add Info</a></div></td>
	  ...
	  while($item=mysql_fetch_array($query_result)){
	   ...
	   ?>
              <tr class="<?= $class ?>" >
                ...
                <td width="45%" height="20" align="left" valign="middle" style="padding-left:10px;"><img src="../uplodeImage/about/<?=$item["image"]?>" width="120" height="60" /></td>
                <td height="20" align="left" style="padding-left:10px;">&nbsp;&nbsp;<a href="add_info.php?menus_id=<?=$item["id"]?>&page_id=<?=$page_id?>" class="style3">Edit </a>&nbsp;&nbsp;<a href="view_info.php?menus_id=<?=$item["id"]?>&page_id=<?=$page_id?>&delete=true" class="style3" onclick="return confirmDelete()">Delete </a> </td>
              </tr>
              <? $i++; } ?>
            </table>
          </div>
