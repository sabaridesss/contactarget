...
if( !isset($_SESSION['username']) ) {
	...
	if(mysql_num_rows($company_result)>0) {
		...
		{
		$query = "update admin set bounce_password='".$bounce_password."',bounce_email='".$bounce_email."',company_admin='".$company."', username='".$title."', password='".$page_name."', user_permission='1',role='".$role_contact."' where  id = '".$menus_id."'";
	...
	{	
		...
		echo	$query = "update admin set bounce_password='".$bounce_password."',bounce_email='".$bounce_email."',company_admin='".$company."', username='".$title."', password='".$page_name."', user_permission='1',role='".$role_contact."' where  id = '".$menus_id."'";
			$rs = mysql_query($query);
			if($rs){
					header("location:user_list.php?msg=3");
					}	 
