...

{
  ...
  $iconimg_view=$iconimg;
				...
				else
				{
			 	...
			 	$query = "update `menu_page_tbl` set `real_description` ='".($real_description)."',
				...
				if(mysql_query($query))
				 {
					...
					if(isset($_REQUEST['parent_id'])) {
						...
						} else if($_REQUEST['action'] == "edit_news_contents") {
						
							header("location:recent_news.php?msg=3");
						}else   {
	...
	{
		header("location:recent_news.php");
	}
					}	
				}
			}
		...
		if(isset($_POST['Update']) && ($_POST['Update'] == "Update")) {
			if($id = $_REQUEST['page_id']) {
				...
				$query = "update `menu_page_tbl` set `img_description` ='".($img_description)."',
												`meta_name` =  '".($meta_name)."',
												 `meta_content` =  '".($meta_content)."',
												 `file_name` = '".($page_name)."',
												 `meta_title` ='".($meta_title)."',
        ...
        <div class="wholesite-inner">
          ...
          <div class="welcome-admin">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="20%" align="left" valign="middle">&nbsp;</td><?php if($_REQUEST['action'] != "edit_news_contents") {
					?>	
