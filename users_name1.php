...
$subscribe1=1;
  ...
  if($count_usertype==0)
  {
		 ...
		 echo $insert = 'INSERT INTO user_tbl 
										SET
...
if(isset($_REQUEST['Submit']) && $_REQUEST['Submit'] == 'Update')
	{ 
	 ...
	 $hid	= $_REQUEST['hid'];
	 $del_user_type=mysql_query("DELETE FROM `user_tbl` WHERE `id` =$hid");
	        $firstname	= $_REQUEST['firstname'];
			$lastname	= $_REQUEST['lastname'];
			$email		= $_REQUEST['email'];
			$subscribe	= $_REQUEST['subscribe'];
...
'mywindow','width=900,height=400,top=200,left=200,scrollbars=yes'); ">category</a></div></td>-->
              ...
              <tr>
                <td align="left" valign="top" class="login-inner"><table width="100%" border="0" align="center" cellpadding="5" >
                    <tr>
                      ...
                      <td align="left"><input name="firstname" type="text" id="firstname" value="<?=$displaySite['firstname']?>" size="60" class="login-texbox1" />
                    ...
                    <tr>
                      ...
                      <td align="left"><input name="lastname" type="text" id="lastname" value="<?=$displaySite['lastname']?>" size="60" class="login-texbox1" /></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top" id="title_name"><span class="font">Email</span>:</td>
                      <td align="left"><input name="email" type="text" id="email" value="<?=$displaySite['email']?>" size="60" class="login-texbox1" /></td>
                    </tr>
                    <tr>
		  ...
		  ?>
                    ...
                    <tr>
                      <td align="right" valign="top">&nbsp;</td>
                      <td align=""><?php if($_REQUEST['id'] != '') { ?>
                        <input type="submit" name="Submit" value="Update" class="addmenu2" onclick="return formValidator()" />
                        <?php } else { ?>
