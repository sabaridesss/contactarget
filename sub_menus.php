...
<div class="welcome-admin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="25%" align="right" valign="middle"><div class="addmenu"><a href="add_submenus.php?parent_id=<?php echo $parent_id?>">Add Sub Menus</a></div></td>
  </tr>
  <tr>
...
<table width="100%" border="0">
      ...
      <tr class="<?= $class ?>">
        ...
        <td width="16%" align="left" style="padding-left:10px;"><a href="sub_menus1.php?parent_id=<?=$item["id"]?>"><?=$item["title"]?></a></td>
        ...
        <td width="5%" style="padding-left:10px;"><a href="sub_menus.php?submenu_id=<?=$item["id"]?>&parent_id=<?=$_REQUEST['parent_id']?>&delete=true" class="style3" onclick='return deleteContent1()'>Delete</a></td>
      </tr>
      <? $i++; } ?>
    </table>
</div>
