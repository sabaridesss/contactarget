...
if( !isset($_SESSION['username']) ) {
	...
	$date = explode("/", $_REQUEST['date']);
		...
		$query = "INSERT INTO menu_page_tbl(title,file_name,order_id,img_description,is_menu,is_show,Created_Date)VALUES('".$title."','".$page_name."','".$menu_order."','".$img_description."',45,1,now())";
	
		$rs = mysql_query($query);
		if($rs){
					header("location:recent_news.php?msg=2");
				}	 
	}
	...
	$date = explode("/", $_REQUEST['date']);
		...
		$query = "INSERT INTO menu_page_tbl(title,file_name,order_id,img_description,is_menu,is_show,Created_Date)VALUES('".$title."','".$page_name."','".$menu_order."','".$img_description."',45,0,now())";
		$rs = mysql_query($query);
		if($rs){
					header("location:recent_news.php?msg=2");
				}	 
...
<div class="content"><br>
  ...
  <tr>
    <td align="left" valign="top" class="login-top">Add News</td>
  </tr>
  <tr>
    <td align="left" valign="top" class="login-inner"><table width="100%" border="0" align="center" cellpadding="5" >
      <tr>
        <td width="210" align="right" valign="top" id="title_name">News Title:</td>
