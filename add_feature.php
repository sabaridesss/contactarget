...
foreach($table_content3 as $key3=>$value3)
	...
	$query = 'INSERT INTO featured_table
								SET
...
echo mysql_error();
		...
		header('location:featured_description.php?msg=2&page_id='.$_POST['page_id']);									
...
{
	header('location:featured_description.php?page_id='.$_POST['page_id']);		
}
