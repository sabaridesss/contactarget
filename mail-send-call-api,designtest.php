...
$template_unsub=' <div class="spacer"></div><div style="text-align:justify; max-width:400px;">This email sent to '.$array_k['email'].' by '.$fromaddress.$mailer_address.' | <a target="_blank" style="color:#FD600B;text-decoration:none;"  href="http://mailtides.com/manage.php?user='.strtr(base64_encode(addslashes(gzcompress(serialize($array_k['id']),9))), '+/=', '-_,').'">Unsubscribe</a> </div><div class="spacer"></div>';
