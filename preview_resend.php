...
header("location:unopened_details.php?send_id=".$campaignid );
...
//
//  var submitTo = 'final_ajax_resend.php?limit1='+limit1val+'&limit2='+limit2val+'&sendid1='+sendid1+'&mailid='+mailid+'&campanyname='+campanyname;
...
function ajax_request(limit1val,limit2val,sendid1,mailid,campanyname) {
  ...
  var submitTo = 'mail-send-call-api-resend.php?limit1='+limit1val+'&limit2='+limit2val+'&sendid1='+sendid1+'&mailid='+mailid+'&campanyname='+campanyname;
 //location.href = submitTo; //uncomment if you need for debugging
  http('POST', submitTo, ajax_response, document.form1);
...
<div>
  <div class="alert alert-block ">
    ...
    <h4 class="alert-heading">Resending emails are in Group &nbsp;:&nbsp;
      <?php 
  ...
  <?php
$no_of_unopened_Blasts_new 	 = $php_mail->Select_Blast_three('comp_user_tbl','send_id','no_of_read','company_admin',$mail_id,0,$company_admin);
$no_of_unopened_new	 		 = mysql_num_rows($no_of_unopened_Blasts_new);
